...
abstract public class Entity : Thing
{
    ...
    protected static Dictionary<Name, Vector2> Size = new() {
        ...
        {Name.Runner3, new(96f,96f)},
        {Name.Phasor3, new(96f,96f)},
        {Name.SpeedField3, new(96f,96f)},
        {Name.Circle3, new(144f,144f)},
        {Name.ShieldField3, new(96f,96f)},
        {Name.Heal3, new(96f,96f)},
        {Name.HealField3, new(96f,96f)},
        {Name.Dark3, new(96f,96f)},
        {Name.InvinField3, new(96f,96f)},
        {Name.Ghost3, new(96f,96f)},
    ...
    protected static Dictionary<Name, Color> DefaultColor = new() {
        ...
        {Name.Runner3, Color.Orange},
        {Name.Phasor3, Color.Yellow},
        {Name.SpeedField3, Color.Gold},
        {Name.Circle3, Color.Brown},
        {Name.ShieldField3, Color.Silver},
        {Name.Heal3, Color.Green},
        {Name.HealField3, Color.GreenYellow},
        {Name.Dark3, Color.Purple},
        {Name.InvinField3, Color.LightBlue},
        {Name.Ghost3, Color.White*0.5f},
    ...
    protected static Dictionary<Name, double> DefaultHealth = new() {
        ...
        {Name.Runner3, 250d},
        {Name.Phasor3, 500d},
        {Name.SpeedField3, 500d},
        {Name.Circle3, 10000d},
        {Name.ShieldField3, 500d},
        {Name.Heal3, 2500d},
        {Name.HealField3, 500d},
        {Name.Dark3, 1000d},
        {Name.InvinField3, 500d},
        {Name.Ghost3, 10000d},
    ...
    protected static Dictionary<Name, int> Money = new() {
        ...
        {Name.Runner3, 100},
        {Name.Phasor3, 100},
        {Name.SpeedField3, 100},
        {Name.Circle3, 200},
        {Name.ShieldField3, 100},
        {Name.Heal3, 100},
        {Name.HealField3, 100},
        {Name.Dark3, 100},
        {Name.InvinField3, 100},
        {Name.Ghost3, 100},
    };
